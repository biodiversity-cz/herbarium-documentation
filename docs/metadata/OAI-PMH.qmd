...
```
GET /oai-pmh?verb=ListIdentifiers&metadataPrefix=ccmm-xml
GET /oai-pmh?verb=ListIdentifiers&metadataPrefix=ccmm-xml&from=2025-01-01
GET /oai-pmh?verb=ListIdentifiers&metadataPrefix=ccmm-xml&set=PRC
```
...
```
GET /oai-pmh?verb=ListRecords&metadataPrefix=ccmm-xml
GET /oai-pmh?verb=ListRecords&metadataPrefix=ccmm-xml&from=2025-01-01&until=2025-12-31
```
...
```
GET /oai-pmh?verb=GetRecord&identifier=oai:herbarium.biodiversity.cz:ark:/12661/nrp1HERB/PR/207734/37900&metadataPrefix=ccmm-xml
```
