...
GET /oai-pmh?verb=ListRecords&metadataPrefix=ccmm-xml&from=2023-01-01&until=2025-12-31
```
...
```
GET /oai-pmh?verb=GetRecord&identifier=oai:herbarium.biodiversity.cz:ark:/12661/nrp1HERB/PRC/123456&metadataPrefix=ccmm-xml
```
