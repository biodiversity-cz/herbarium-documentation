...
- *acronymMustBePresent* - a presence of international herbarium acronym at the start of the specimenID is expected. For regional museums, often having IDs like “B 00123”, turning off this option relaxes such expectations. ON in the default configuration (= the international acronym is required).
- *alwaysTrailingZeros* - trailing zeros are added only to strictly numeric IDs. If herbarium wants to have these zeros even in case of mixed IDs (like 00123b), this is the option; changeable only by superuser.
