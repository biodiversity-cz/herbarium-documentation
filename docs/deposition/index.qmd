...
- *alwaysTrailingZeros* - trailing zeros are added only to strictly numeric IDs. If herbarium want to have these zeros even in case of mixed IDs (like 00123b), this is the option; changeable only by superuser.
